...
*******************************************************************************/
function bg_get_easter($year, $old=false) {
	$a=((19*($year%19)+15)%30);
...
*******************************************************************************/
function bg_get_sunday_after_exaltation($year, $old=false) {
...
/*========================================================================================
 ...
 ========================================================================================*/
function bg_Gospel_at_Liturgy ($date) {
...
/*Лк*/		'169'=>'Лк.3:19-22','170'=>'Лк.3:23-4:1','171'=>'Лк.4:1-15','172'=>'Лк.4:16-22','173'=>'Лк.4:22-30','174'=>'Лк.4:31-36','175'=>'Лк.5:1-11',				// 18 по Пятидесятнице
	...
	$interval_exaltation = bg_date_easter_dif($sunday_after_exaltation, $year);// Количество дней до Недели по Воздвижению от Пасхи
	...
	$sunday_holy_forefathers = bg_get_sunday_holy_forefathers($year);	// Неделя по Святых Праотец
	$interval_holy_forefathers = bg_date_easter_dif($sunday_holy_forefathers, $year);	// Количество дней до Недели Святых Праотец
...
/*========================================================================================
 ...
 ========================================================================================*/
function bg_Apostol_at_Liturgy ($date) {
...
/*========================================================================================
	...
	Возвращает:
		Текст, содержащий список ссылок на Евангелие
 ========================================================================================*/
function bg_Gospel_at_Matins ($date) {
	...
	$interval_last_year = bg_date_easter_dif($date, $year-1);	// Дней от предыдущей Пасхи
	...
	if ($is_sunday && $date < $palm_sunday) {								// До Вербного воскресенья завершаем круг чтения прошлого года
		if ($date == $christmas || $date == $christmas) return "";			// В Рождество и Богоявление, рядовое воскресное зачало не читается
		$week = ($interval_last_year/7 + 7)%11;	

...
/*======================================================================================================
	...
	2.1 - чтения Недели о Закхее всегда из 32 Недели. 
		(Всегда ли седмичные чтения перед Неделей о Закхее 32 седмицы?)
...
*******************************************************************************/
	public function bg_get_end_of_cycle ($year, $old=false) {
 ...
 ========================================================================================*/
	public function bg_Gospel_at_Liturgy ($date) {
		$gl = [	'-104'=>'Мк.8:11-21','-103'=>'Мк.8:22-26','-102'=>'Мк.8:30-34','-101'=>'Мк.9:10-16','-100'=>'Мк.9:33-41','-99'=>'Лк.14:1-11','-98'=>'Лк.18:18-27',		// Повтор 30 по Пятидесятнице ****
				...
				'141'=>'Мк.4:10-23','142'=>'Мк.4:24-34','143'=>'Мк.4:35-41','144'=>'Мк.5:1-20','145'=>'Мк.5:22-24,5:35-6:1','146'=>'Мф.23:1-12','147'=>'Мф.22:1-14',		// 14 по Пятидесятнице
	...
	/*Лк*/		'169'=>'Лк.3:19-22','170'=>'Лк.3:23-4:1','171'=>'Лк.4:1-15','172'=>'Лк.4:16-22','173'=>'Лк.4:22-30','174'=>'Лк.4:31-36','175'=>'Лк.5:1-11',				// 18 по Пятидесятнице
		...
		// В Неделю по Закхею всегда чтение 32 седмицы
		if ($interval == -77) {
			$gl[$key] = 'Лк.19:1-10';
		}
 ...
 ========================================================================================*/
	public function bg_Apostol_at_Liturgy ($date) {
		$al = [	'-104'=>'Евр.8:7-13','-103'=>'Евр.9:8-10,15-23','-102'=>'Евр.10:1-18','-101'=>'Евр.10:35-11:7 ','-100'=>'Евр.11:8,11-16','-99'=>'Еф.5:1-8','-98'=>'Кол.3:12-16',	// Повтор 30 по Пятидесятнице ****	
				'-97'=>'Евр.11:17-23,27-31','-96'=>'Евр.12:25-26,13:22-25','-95'=>'Иак.1:1-18','-94'=>'Иак.1:19-27','-93'=>'Иак.2:1-13','-92'=>'Кол.1:3-6','-91'=>'1Тим.1:15-17',	// Повтор 31 по Пятидесятнице ***
				'-90'=>'Еф.1:22-2:3','-89'=>'Еф.2:19-3:7','-88'=>'Еф.3:8-21','-87'=>'Еф.4:14-19','-86'=>'Еф.4:17-25','-85'=>'1Кор.14:20-25','-84'=>'2Кор.6:16-7:1',				// Повтор 17 по Пятидесятнице *****
				'-83'=>'Иак.2:14-26','-82'=>'Иак.3:1-10','-81'=>'Иак.3:11-4:6','-80'=>'Иак.4:7-5:9','-79'=>'1Пет.1:1-2,10-12,2:6-10','-78'=>'1Сол.5:14-23','-77'=>'1Тим.4:9-15',	// О Закхее: повтор 32 по Пятидесятнице **	
				'-76'=>'1Пет.2:21-3:9','-75'=>'1Пет.3:10-22','-74'=>'1Пет.4:1-11','-73'=>'1Пет.4:12-5:5','-72'=>'2Пет.1:1-10','-71'=>'2Тим.2:11-19','-70'=>'2Тим.3:10-15',	// О мытаре и фарисее: повтор 33 по Пятидесятнице *
				'-69'=>'2Пет.1:20-2:9','-68'=>'2Пет.2:9-22','-67'=>'2Пет.3:1-18','-66'=>'1Ин.1:8-2:6','-65'=>'1Ин.2:7-17','-64'=>'2Тим.3:1-9','-63'=>'1Кор.6:12-20',			// О блудном сыне
				'-62'=>'1Ин.2:18-3:10','-61'=>'1Ин.3:11-20','-60'=>'1Ин.3:21-4:6','-59'=>'1Ин.4:20-5:21','-58'=>'2Ин.1:1-13','-57'=>'1Кор.10:23-28','-56'=>'1Кор.8:8-9:2',	// О страшном суде
				'-55'=>'3Ин.1:1-15','-54'=>'Иуд.1:1-10','-52'=>'Иуд.1:11-25','-50'=>'Рим.14:19-26','-49'=>'Рим.13:11-14:4',														// Прощенное воскресение
				...
				'-3'=>'1Кор.11:23-32','-1'=>'Рим.6:3-11',			// Страстная
				'0'=>'Деян.1:1-8',									// Пасха
				...
				'85'=>'Рим.16:17-24','86'=>'1Кор.1:1-9','87'=>'1Кор.2:9-3:8','88'=>'1Кор.3:18-23','89'=>'1Кор.4:5-8','90'=>'Рим.9:1-5','91'=>'Рим.12:6-14',						// 6 по Пятидесятнице
				'92'=>'1Кор.5:9-6:11','93'=>'1Кор.6:20-7:12','94'=>'1Кор.7:12-24','95'=>'1Кор.7:24-35','96'=>'1Кор.7:35-8:7','97'=>'Рим.12:1-3','98'=>'Рим.15:1-7',			// 7 по Пятидесятнице
				'99'=>'1Кор.9:13-18','100'=>'1Кор.10:5-12','101'=>'1Кор.10:12-22','102'=>'1Кор.10:28-11:7','103'=>'1Кор.11:8-22','104'=>'Рим.13:1-10','105'=>'1Кор.1:10-18',	// 8 по Пятидесятнице
				'106'=>'1Кор.11:31-12:6','107'=>'1Кор.12:12-26','108'=>'1Кор.13:4-14:5','109'=>'1Кор.14:6-19','110'=>'1Кор.14:26-40','111'=>'Рим.14:6-9','112'=>'1Кор.3:9-17',// 9 по Пятидесятнице
				'113'=>'1Кор.15:12-19','114'=>'1Кор.15:29-38','115'=>'1Кор.16:4-12','116'=>'2Кор.1:1-7','117'=>'2Кор.1:12-20','118'=>'Рим.15:30-33','119'=>'1Кор.4:9-16',		// 10 по Пятидесятнице
				'120'=>'2Кор.2:4-15','121'=>'2Кор.2:14-3:3','122'=>'2Кор.3:4-11','123'=>'2Кор.4:1-6','124'=>'2Кор.4:13-18','125'=>'1Кор.1:3-9','126'=>'1Кор.9:2-12',			// 11 по Пятидесятнице
				'127'=>'2Кор.5:10-15','128'=>'2Кор.5:15-21','129'=>'2Кор.6:11-16','130'=>'2Кор.7:1-10','131'=>'2Кор.7:10-16','132'=>'1Кор.1:26-29','133'=>'1Кор.15:1-11',	// 12 по Пятидесятнице	
				'134'=>'2Кор.8:7-15','135'=>'2Кор.8:16-9:5','136'=>'2Кор.9:12-10:7','137'=>'2Кор.10:7-18','138'=>'2Кор.11:5-21','139'=>'1Кор.2:6-9','140'=>'1Кор.16:13-24',	// 13 по Пятидесятнице
				'141'=>'2Кор.12:10-19','142'=>'2Кор.12:20-13:2','143'=>'2Кор.13:3-13','144'=>'Гал.1:1-10,20-2:5','145'=>'Гал.2:6-10','146'=>'1Кор.4:1-5','147'=>'2Кор.1:21-2:4',// 14 по Пятидесятнице
				'148'=>'Гал.2:11-16','149'=>'Гал.2:21-3:7','150'=>'Гал.3:15-22','151'=>'Гал.3:23-4:5','152'=>'Гал.4:8-21','153'=>'1Кор.4:17-5:5','154'=>'2Кор.4:6-15',			// 15 по Пятидесятнице
				'155'=>'Гал.4:28-5:10','156'=>'Гал.5:11-21','157'=>'Гал.6:2-10','158'=>'Еф.1:1-9','159'=>'Еф.1:7-17','160'=>'1Кор.10:23-28','161'=>'2Кор.6:1-10',					// 16 по Пятидесятнице
				'162'=>'Еф.1:22-2:3','163'=>'Еф.2:19-3:7','164'=>'Еф.3:8-21','165'=>'Еф.4:14-19','166'=>'Еф.4:17-25','167'=>'1Кор.14:20-25','168'=>'2Кор.6:16-7:1',				// 17 по Пятидесятнице ***
				'169'=>'Еф.4:25-32','170'=>'Еф.5:20-26','171'=>'Еф.5:25-33','172'=>'Еф.5:33-6:9','173'=>'Еф.6:18-24','174'=>'1Кор.15:39-45','175'=>'2Кор.9:6-11',					// 18 по Пятидесятнице
				'176'=>'Флп.1:1-7','177'=>'Флп.1:8-14','178'=>'Флп.1:12-20','179'=>'Флп.1:20-27','180'=>'Флп.1:27-2:4','181'=>'1Кор.15:58-16:3','182'=>'2Кор.11:31-12:9',			// 19 по Пятидесятнице
				'183'=>'Флп.2:12-16','184'=>'Флп.2:17-23','185'=>'Флп.2:24-30','186'=>'Флп.3:1-8','187'=>'Флп.3:8-19','188'=>'2Кор.1:8-11','189'=>'Гал.1:11-19',					// 20 по Пятидесятнице
				'190'=>'Флп.4:10-23','191'=>'Кол.1:1-2,7-11','192'=>'Кол.1:18-23','193'=>'Кол.1:24-29','194'=>'Кол.2:1-7','195'=>'2Кор.3:12-18','196'=>'Гал.2:16-20',				// 21 по Пятидесятнице
				'197'=>'Кол.2:13-20','198'=>'Кол.2:20-3:3','199'=>'Кол.3:17-4:1','200'=>'Кол.4:2-9','201'=>'Кол.4:10-18','202'=>'2Кор.5:1-10','203'=>'Гал.6:11-18',				// 22 по Пятидесятнице
				'204'=>'1Сол.1:1-5','205'=>'1Сол.1:6-10','206'=>'1Сол.2:1-8','207'=>'1Сол.2:9-14','208'=>'1Сол.2:14-19','209'=>'2Кор.8:1-5','210'=>'Еф.2:4-10',				// 23 по Пятидесятнице
				'211'=>'1Сол.2:20-3:8','212'=>'1Сол.3:9-13','213'=>'1Сол.4:1-12','214'=>'1Сол.5:1-8 ','215'=>'1Сол.5:9-13,24-28','216'=>'2Кор.11:1-6','217'=>'Еф.2:14-22',	// 24 по Пятидесятнице
				'218'=>'2Сол.1:1-10','219'=>'2Сол.1:10-2:2','220'=>'2Сол.2:1-12','221'=>'2Сол.2:13-3:5','222'=>'2Сол.3:6-18','223'=>'Гал.1:3-10','224'=>'Еф.4:1-6',			// 25 по Пятидесятнице
				'225'=>'1Тим.1:1-7','226'=>'1Тим.1:8-14','227'=>'1Тим.1:18-20,2:8-15','228'=>'1Тим.3:1-13','229'=>'1Тим.4:4-8,16','230'=>'Гал.3:8-12','231'=>'Еф.5:8-19',		// 26 по Пятидесятнице
				'232'=>'1Тим.5:1-10','233'=>'1Тим.5:11-21','234'=>'1Тим.5:22-6:11','235'=>'1Тим.6:17-21','236'=>'2Тим.1:1-2,8-18','237'=>'Гал.5:22-6:2','238'=>'Еф.6:10-17',	// 27 по Пятидесятнице
				'239'=>'2Тим.2:20-26','240'=>'2Тим.3:16-4:4','241'=>'2Тим.4:9-22','242'=>'Тит.1:5-2:1','243'=>'Тит.1:15-2:10','244'=>'Еф.1:16-23','245'=>'Кол.1:12-18',			// 28 по Пятидесятнице
				...
				'260'=>'Евр.11:17-23,27-31','261'=>'Евр.12:25-26,13:22-25','262'=>'Иак.1:1-18','263'=>'Иак.1:19-27','264'=>'Иак.2:1-13','265'=>'Кол.1:3-6','266'=>'1Тим.1:15-17',	// 31 по Пятидесятнице ****
				'267'=>'Иак.2:14-26','268'=>'Иак.3:1-10','269'=>'Иак.3:11-4:6','270'=>'Иак.4:7-5:9','271'=>'1Пет.1:1-2,10-12,2:6-10','272'=>'1Сол.5:14-23','273'=>'1Тим.4:9-15',// 32 по Пятидесятнице **
				'274'=>'1Пет.2:21-3:9','275'=>'1Пет.3:10-22','276'=>'1Пет.4:1-11','277'=>'1Пет.4:12-5:5','278'=>'2Пет.1:1-10','279'=>'2Тим.2:11-19','280'=>'2Тим.3:10-15'];	// 33 по Пятидесятнице *
		...
		// В Неделю по Закхею всегда чтение 32 седмицы ("Апостолы всегда сопровождают свои Евангелие" ?)
		if ($interval == -77) {
			$al[$key] = '1Тим.4:9-15';
		}
